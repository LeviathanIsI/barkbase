  ...
  return {
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          name: 'BarkBase Demo',
          short_name: 'BarkBase Demo',
          description: 'Interactive demo of BarkBase kennel management.',
          theme_color: '#3b82f6',
    ...
    server: {
      host: true,
      port: toNumber(env.VITE_PORT, 5174),
      open: false,
      hmr: {
        overlay: true,
      },
    ...
    preview: {
      host: true,
      port: toNumber(env.VITE_PREVIEW_PORT, 4174),
    },
    envPrefix: 'VITE_',
    define: {
