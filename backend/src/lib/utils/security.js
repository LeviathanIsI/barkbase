\/**
 \* Shared Security Utilities for BarkBase Backend
 \* Copied from the existing Lambda shared utilities to keep behaviour identical
 \* during the consolidation effort.
 \*/
