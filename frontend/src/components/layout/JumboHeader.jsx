      ...
      <div className="flex h-full items-center justify-between px-6">
        ...
        <div className="flex-1 max-w-md mx-8">
          <div className="relative">
            <div className="flex items-center bg-white dark:bg-surface-primary/10 rounded-lg px-4 py-2 hover:bg-white dark:hover:bg-surface-primary/20 transition-colors">
