...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Records & Objects', to: '/settings/records' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Communication Alerts', to: '/settings/communication-notifications' },
    ],
  },
  {
    id: 'booking',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Mobile', to: '/settings/mobile', badge: { label: 'BETA', tone: 'info' } },
    ],
  },
  {
    id: 'compliance',
  ...
  },
  {
    ...
    items: [
      { label: 'Reporting & Analytics', to: '/settings/reporting' },
    ],
  },
];
...
const SettingsSidebar = () => {
  ...
  const renderBadge = (badge) => {
    ...
    return (
      <Badge variant={tone === 'info' ? 'info' : 'primary'} className={tone === 'info' ? 'bg-primary/10 text-primary' : undefined}>
        {badge.label}
      </Badge>
    );
  };
  ...
  return (
    <aside className="flex h-full min-h-0 w-72 flex-shrink-0 flex-col border-r border-border/70 bg-surface/40 lg:sticky lg:top-6 lg:h-[calc(100vh-3rem)] lg:overflow-hidden lg:rounded-2xl lg:border lg:bg-surface lg:shadow-sm">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5">
        <div className="mb-6">
          ...
          <p className="mt-1 text-xs text-muted">Manage how BarkBase runs for your team and customers.</p>
        </div>
