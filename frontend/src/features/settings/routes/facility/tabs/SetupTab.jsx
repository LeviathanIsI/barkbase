...
export default function SetupTab() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-surface-primary rounded-lg p-6 w-full max-w-md mx-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-red-900 dark:text-red-100">Reset Facility Settings</h3>
            </div>

            <p className="text-gray-700 dark:text-text-primary mb-6">
      ...
      {showWizard && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-surface-primary rounded-lg p-6 w-full max-w-2xl mx-4">
