    ...
    <Card title="Push Notifications" icon={Smartphone}>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="border border-red-200 bg-red-50 rounded-lg p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h4 className="font-medium text-red-900">iOS App</h4>
                <p className="text-sm text-red-800">Not installed</p>
              </div>
            </div>
            <Button
              variant="outline"
          ...
          <div className="border border-red-200 bg-red-50 rounded-lg p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h4 className="font-medium text-red-900">Android App</h4>
                <p className="text-sm text-red-800">Not installed</p>
              </div>
            </div>
            <Button
        ...
        <div className="opacity-50">
          <h3 className="font-medium text-gray-900 mb-4">Push notification settings</h3>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          <h4 className="font-medium text-gray-900 mb-2">Mobile App Benefits</h4>
