  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900">Developer API</h2>
          <p className="text-sm text-gray-600">Build custom integrations with our REST API</p>
        </div>
      </div>
        ...
        <div className="border border-gray-200 rounded-lg p-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">⭐ Pro Feature</p>
            </div>
          </div>
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-sm text-blue-800">
          ...
          <br />
          <span className="text-blue-700">- Dev Team, Paws Paradise</span>
        </p>
      </div>
