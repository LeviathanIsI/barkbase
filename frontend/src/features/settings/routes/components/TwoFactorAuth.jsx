        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <ul className="text-sm text-gray-600 mt-1 space-y-1 ml-6">
            ...
            <div className="text-right">
              ...
              {!twoFactorEnabled ? (
                ...
                <div>
                  <p className="text-sm text-gray-600 mb-1">Method: Authenticator App</p>
                  <p className="text-sm text-gray-600 mb-2">Enabled: Jan 15, 2025</p>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-2 mb-3">
                {backupCodes.map((code, index) => (
                  <div key={index} className="bg-white border border-green-200 rounded px-2 py-1 text-center text-sm font-mono">
                    {code}
                  </div>
                ))}
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg w-full max-w-md">
            ...
            <div className="p-6">
              {setupStep === 1 ? (
                <div className="space-y-4">
                  <h3 className="font-medium text-gray-900 mb-4">Step 1: Choose Your Method</h3>
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    <h3 className="font-medium text-gray-900 mb-4">Step 2: Scan QR Code</h3>

                    {/* Mock QR Code */}
                    <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg p-8 mx-auto w-48 h-48 flex items-center justify-center mb-4">
