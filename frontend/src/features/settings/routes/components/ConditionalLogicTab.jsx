    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
        <div className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Conditional Logic</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-blue-800">Show "Medication Instructions" only if "Requires Medication" is checked</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                <span className="text-blue-500 font-bold mt-0.5">•</span>
                <div>
                  <p className="font-medium text-blue-800">Show "Separation Anxiety Notes" only if behavioral flag includes "Anxious"</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                <span className="text-blue-500 font-bold mt-0.5">•</span>
                <div>
                  <p className="font-medium text-blue-800">Show "Suite Preference" only if booking type is "Boarding"</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                <span className="text-blue-500 font-bold mt-0.5">•</span>
                <div>
                  <p className="font-medium text-blue-800">Show "Pick-up Authorization" only if owner is different from booking contact</p>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-500">
            ...
            <a href="#" className="text-blue-600 hover:underline">Watch our tutorial</a>
            {' '}or{' '}
