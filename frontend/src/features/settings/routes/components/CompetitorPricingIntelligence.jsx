    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Track competitor pricing in your area</p>
          </div>
        </div>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div>
            <div className="text-2xl font-bold text-gray-900">${marketLow}</div>
            <div className="text-xs text-gray-600">Market Low</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-blue-600">${yourPrice}</div>
            <div className="text-xs text-blue-600">Your Price</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-gray-900">${marketAverage}</div>
            <div className="text-xs text-gray-600">Market Avg</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-gray-900">${marketHigh}</div>
            <div className="text-xs text-gray-600">Market High</div>
          </div>
        </div>
      ...
      <div className="mb-6">
        <h3 className="font-medium text-gray-900 mb-4">Standard Boarding Comparison</h3>
        <div className="space-y-3">
            ...
            <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600">{competitor.distance} • ⭐ {competitor.rating}</div>
                </div>
              </div>
              <div className="text-right">
                <div className="font-medium text-gray-900">${competitor.price}</div>
          ...
          {/* Your position */}
          <div className="flex items-center justify-between p-3 bg-blue-50 border-2 border-blue-200 rounded">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                <span className="text-xs font-bold text-blue-600">YOU</span>
              </div>
              <div>
                <div className="font-medium text-blue-900">BarkBase</div>
                <div className="text-xs text-blue-700">Your facility</div>
              </div>
            </div>
            <div className="text-right">
              <div className="font-medium text-blue-900">${yourPrice}</div>
