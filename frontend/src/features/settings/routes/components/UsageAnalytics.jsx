  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h2 className="text-xl font-semibold text-blue-900">Property Usage Insights</h2>
      </div>
            ...
            <div key={index} className="bg-white rounded-lg p-4 border border-blue-100">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-900">{insight.label}</p>
                  {insight.action && (
      ...
      <div className="mt-6 pt-4 border-t border-blue-200">
        <div className="flex items-center justify-between text-sm">
          <span className="text-blue-700">Overall Usage Rate:</span>
          <span className="font-semibold text-blue-900">{usageRate}% of pets have custom properties</span>
        </div>
