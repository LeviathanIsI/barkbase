...
const FacilityDetailsModal = ({ facility, pets = [], onClose, onBook }) => {
  ...
  const getOccupancyColor = () => {
    if (occupancyRate >= 95) return 'text-gray-600';
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">{facility.building || facility.type}</p>
            </div>
          </div>
          <button
            onClick={onClose}
              ...
              {pets.map((pet, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-gray-900">{pet.name || pet.petName}</p>
                    {pet.breed && (
