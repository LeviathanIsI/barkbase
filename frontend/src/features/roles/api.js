...
export const useCreateRole = () => {
  ...
  return useMutation({
    ...
    onSuccess: (response) => {
      ...
      // Use exact query key that useRoles({}) uses
      const currentData = queryClient.getQueryData(roleKeys.list({}));
      if (currentData?.data) {
        queryClient.setQueryData(roleKeys.list({}), {
          ...currentData,
          data: [...currentData.data, newRole],
        });
      }
