      ...
      <div className="bg-white rounded-lg w-full max-w-2xl">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-600">{data.title} - {data.period}</p>
          </div>
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Include Options */}
          <div>
            <h4 className="text-sm font-semibold text-gray-900 mb-3">INCLUDE</h4>
          ...
          {/* Delivery Method */}
          <div>
            <h4 className="text-sm font-semibold text-gray-900 mb-3">DELIVERY METHOD</h4>
            <div className="space-y-3">
              ...
              <div className="ml-6 space-y-2">
                <label className="flex items-center gap-3">
                  <input type="radio" name="delivery" className="text-blue-600" />
                ...
                />
                <button className="ml-6 text-sm text-blue-600 hover:text-blue-700">
                  + Add recipient
                </button>
              </div>
              ...
              <div className="ml-6">
                <span className="text-sm text-gray-600">Folder: /Reports/Revenue/</span>
