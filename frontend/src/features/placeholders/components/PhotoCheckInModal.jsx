      ...
      <div className="bg-white dark:bg-surface-primary rounded-lg w-full max-w-md">
        <div className="p-6">
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-text-primary mb-2">Photo Check-In</h3>
            <p className="text-gray-600 dark:text-text-secondary mb-6">Snap a photo to identify the pet</p>

            {!identifying && !identified ? (
              <div className="bg-gray-100 dark:bg-surface-secondary rounded-lg p-8 mb-6">
                <User className="w-16 h-16 text-gray-400 dark:text-text-tertiary mx-auto mb-2" />
                <p className="text-gray-600 dark:text-text-secondary mb-2">Center pet in frame</p>
              ...
              <div className="bg-blue-50 dark:bg-surface-primary border border-blue-200 dark:border-blue-900/30 rounded-lg p-4 mb-6">
                <div className="animate-pulse">
                  <p className="text-blue-800 dark:text-blue-200 mb-2">🤖 Identifying pet...</p>
