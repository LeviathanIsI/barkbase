    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">Batch Check-In</h3>
        ...
        <div className="p-6">
          <p className="text-gray-600 mb-6">Process multiple arrivals at once</p>

          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              <h4 className="font-semibold text-gray-900">Scheduled arrivals today ({pets.length}):</h4>
          ...
          <div className="border-t border-gray-200 pt-6">
            <h4 className="font-semibold text-gray-900 mb-4">Batch Actions ({selectedPets.size} selected):</h4>
